<x-guest-layout>
    <form method="POST" action="{{ route('registers') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="no_sim" class="block mt-1 w-full" type="number" name="no_sim" :value="old('no_sim')"
                required autocomplete="no_sim" />
        ...
        {{-- @if (Laravel\Jetstream\Jetstream::hasRoles())
            <div class="mt-4">
                ...
                <x-select id="role" class="block mt-1 w-full" name="role" :options="$roles" />
